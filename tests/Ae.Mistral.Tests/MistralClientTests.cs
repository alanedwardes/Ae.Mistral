...
public class MistralClientTests
{
    ...
    [Fact]
    public async Task CreateChatCompletionStreamAsync_TreatsReferenceChunksAsIgnoredInArrayDeltaContent()
    {
        const string sse =
            "data: {\"id\":\"abc\",\"model\":\"m\",\"choices\":[{\"index\":0,\"delta\":{\"role\":\"assistant\",\"content\":[{\"type\":\"text\",\"text\":\"Hello\"},{\"type\":\"reference\",\"reference_ids\":[1,2]},{\"type\":\"text\",\"text\":\" there\"}]},\"finish_reason\":null}]}\n\n" +
            "data: [DONE]\n\n";
